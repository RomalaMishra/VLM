# AI Navigation Project (IN WORKS)

A vision-language robot navigation system built progressively
across four versions. The project begins with a static accessibility assistant and
evolves into a full embodied AI system where a robot navigates a dynamic simulated
